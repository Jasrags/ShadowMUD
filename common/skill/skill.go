...
var CoreSkills = []Spec{
	// BODY
	{
		...
		LinkedAttribute: shared.AttributeBody,
	...
	// AGILITY
	{
		...
		LinkedAttribute: shared.AttributeAgility,
		Specializations: []string{
			"Bow",
			"Crossbow",
	...
	// REACTION
	{
		...
		Defaultable:     false,
		Category:        SkillCategoryVehicle,
		LinkedAttribute: shared.AttributeReaction,
		Specializations: []string{
			"Deep Space",
			"Launch Craft",
			"Remote Operation",
	...
	// STRENGTH
	{
		...
		LinkedAttribute:        shared.AttributeStrength,
		Specializations: []string{
			"Desert",
			"Distance",
			"Sprinting",
	...
	// WILLPOWER
	{
		...
		LinkedAttribute: shared.AttributeWillpower,
		Specializations: []string{
			"Magicians",
			"Mana Barriers",
			"Spirits"},
	...
	// CHARISMA
	{
		...
		Defaultable:     true,
		Category:        SkillCategoryTechnical,
		LinkedAttribute: shared.AttributeCharisma,
		Specializations: []string{
			"Herding",
			"Riding",
			"Training"},
	...
	// 	Defaultable:     true,
	// 	LinkedAttribute: shared.AttributeLogic,
	...
	// INTUITION
	{
		...
		Defaultable:     false,
		Category:        SkillCategoryTechnical,
		LinkedAttribute: shared.AttributeIntuition,
		Specializations: []string{
			"Carpentry",
			"Cooking",
			"Drawing",
	...
	// MAGIC
	{
		...
		Defaultable:     false,
		Category:        SkillCategoryMagical,
		LinkedAttribute: shared.AttributeMagic,
		Specializations: []string{
			"Combat",
			"Command",
			"Contact",
	...
	// RESONANCE
	{
		...
		Group:           "tasking",
		LinkedAttribute: shared.AttributeResonance,

		...
		Armor: []core.Armor{
			{
				ID:            "sync_leather",
				ArmorRating:   4,
				Modifications: []core.ArmorModification{},
				...
				Spec: core.ArmorSpec{
					...
					Capacity:    4,
					Cost:        200,
					RuleSource:  core.RuleSourceSR5Core,
					ItemTags:    []core.ItemTag{core.ItemTagArmor, core.ItemTagClothing},
				},
			},
		},
	}
...
func SaveCharacter(c *core.Character) error {
	filename := fmt.Sprintf("../"+core.CharacterFilename, c.ID)
	return util.SaveStructToYAML(filename, c)
}
